...
class Game extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('score, board_id, player', 'required'),
			array('score, board_id', 'numerical', 'integerOnly'=>true),
			array('player', 'length', 'max'=>128),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, score, board_id, player', 'safe', 'on'=>'search'),
		);
	}
